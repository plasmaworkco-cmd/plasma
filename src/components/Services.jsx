...
const Services = () => {
  ...
  return (
    <section id="solutions" className="bg-secondary-black py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="mb-20 text-center md:text-left">
          <h2 className="text-5xl md:text-7xl font-black text-primary-text mb-6 tracking-tighter font-heading">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="group relative p-10 rounded-[2rem] bg-deep-black border border-mint/5 transition-all duration-700 hover:border-emerald/40 hover:-translate-y-3">
