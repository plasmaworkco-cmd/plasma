        ...
        <section id="process" className="bg-secondary-black py-24 md:py-40 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
                    ...
                    <div className="relative space-y-12 pl-10">
                        ...
                        {steps.map((step, idx) => (
                            ...
                            >
                                ...
                                <h3 className="text-3xl font-black text-primary-text mb-4 tracking-tight font-heading">
                                    {step.name}
                                </h3>
                                <p className={`text-muted-text leading-relaxed transition-all duration-500 overflow-hidden max-w-sm font-body ${idx === activeStep ? 'max-h-32 opacity-100' : 'max-h-0 opacity-0'}`}>
                                    {step.desc}
                                </p>
                            </div>
                        ))}
                ...
                <div className="hidden lg:block relative group">
                    ...
                    <div className="relative bg-deep-black rounded-[3rem] border border-mint/10 p-16 h-[600px] flex flex-col justify-between overflow-hidden">
                        {/* Grid Overlay */}
                        ...
                        <div className="flex justify-between items-start relative z-10">
                            <div className="text-muted-text font-mono text-xs tracking-widest uppercase">
                        ...
                        <div className="relative flex items-center justify-center">
                            ...
                            <span className="text-[180px] font-black text-primary-text/5 select-none tracking-tighter font-heading">
                                {steps[activeStep].id}
                            </span>
                        </div>
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex justify-between text-[10px] font-mono text-muted-text uppercase tracking-widest">
