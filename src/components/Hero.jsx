  ...
  return (
    <section className="relative min-h-screen bg-primary flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        {/* TOP BADGE */}
        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-mint/10 bg-secondary/40 backdrop-blur-lg mb-12">
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald"></span>
          </span>
          <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-text-primary font-heading">
            Premium Web Development
          </span>
        </div>

        {/* HEADLINE: More Business Impact */}
        <h1 className="text-4xl sm:text-6xl md:text-8xl font-black text-text-primary leading-[1.05] tracking-tight font-heading">
          WE BUILD <br />
        ...
        <p className="mt-8 max-w-2xl mx-auto text-text-secondary text-lg md:text-xl leading-relaxed font-body">
        ...
        <div className="mt-14 flex flex-col items-center justify-center gap-6">
          <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
            <button className="group relative w-full sm:w-auto px-10 py-4 bg-emerald text-black font-bold text-lg rounded-lg transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(80,200,120,0.4)] active:scale-95 overflow-hidden font-heading tracking-wide shadow-lg">
            ...
            <button className="w-full sm:w-auto px-10 py-4 border border-white/10 text-text-primary font-bold text-lg rounded-lg hover:border-emerald hover:text-emerald transition-colors font-heading tracking-wide">
              View Our Work
            </button>
          </div>
          
          {/* Trust Micro-Line */}
          <p className="mt-2 text-sm text-text-secondary font-body opacity-80">
