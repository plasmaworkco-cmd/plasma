...
const Technologies = () => {
  ...
  return (
    <section id="the-stack" className="bg-deep-black py-32 border-t border-mint/5 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 mb-16">
        <div className="flex flex-col md:flex-row items-end justify-between gap-6">
          <div className="max-w-xl">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-primary-text tracking-tighter uppercase italic font-heading">
        ...
        <div className="flex animate-marquee whitespace-nowrap">
          ...
          {[...techs, ...techs].map((tech, idx) => (
            <div key={idx} className="flex items-center gap-6 mx-12">
              ...
              <span className="text-5xl md:text-7xl font-black text-primary-text/10 group-hover:text-primary-text transition-colors duration-700 tracking-tighter uppercase italic font-heading select-none">
                {tech}
              </span>
            </div>
          ))}
