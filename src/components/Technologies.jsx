...
const Technologies = () => {
  ...
  return (
    <section id="the-stack" className="bg-primary py-20 md:py-32 border-t border-mint/5 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 mb-12 md:mb-16">
        <div className="flex flex-col md:flex-row items-end justify-between gap-6">
          <div className="max-w-xl">
            ...
            <h3 className="text-3xl md:text-5xl font-black text-text-primary tracking-tighter uppercase italic font-heading">
              The <span className="text-mint">Stack.</span>
            </h3>
          </div>
          <div className="text-text-secondary text-sm font-mono max-w-xs opacity-60 text-right md:text-left">
        ...
        <div className="flex animate-marquee whitespace-nowrap">
          ...
          {[...techs, ...techs].map((tech, idx) => (
            <div key={idx} className="flex items-center gap-4 md:gap-6 mx-8 md:mx-12">
              ...
              <span className="text-4xl md:text-7xl font-black text-text-primary/10 group-hover:text-text-primary transition-colors duration-700 tracking-tighter uppercase italic font-heading select-none">
                {tech}
              </span>
            </div>
          ))}
