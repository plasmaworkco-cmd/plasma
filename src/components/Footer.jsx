    ...
    <footer className="bg-deep-black pt-16 pb-8 md:pt-24 md:pb-12 border-t border-mint/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-16 relative z-10">
        ...
        <div className="col-span-1">
          <h3 className="text-3xl font-black text-primary-text mb-6 tracking-tighter font-heading">
            PLASMA<span className="text-emerald">.</span>
          </h3>
          <p className="text-muted-text leading-relaxed mb-8 font-body">
        ...
        {/* Navigation Mapping */}
        <div>
          <h4 className="text-primary-text font-black uppercase tracking-widest text-xs mb-8 font-heading">Navigation</h4>
        ...
        {/* Governance / Legal */}
        <div>
           <h4 className="text-primary-text font-black uppercase tracking-widest text-xs mb-8 font-heading">Governance</h4>
           <ul className="space-y-4">
             <li><a href="#" className="text-muted-text hover:text-mint transition-colors font-body">Privacy Policy</a></li>
             <li><a href="#" className="text-muted-text hover:text-mint transition-colors font-body">Terms of Service</a></li>
             <li><a href="#" className="text-muted-text hover:text-mint transition-colors font-body">Cookie Policy</a></li>
           </ul>
        </div>

        {/* Connection Matrix (Socials) */}
        <div>
          <h4 className="text-primary-text font-black uppercase tracking-widest text-xs mb-8 font-heading">Connect</h4>
          <div className="flex gap-4">
            ...
            {[
              ...
              <a key={social.name} href="#" className="w-12 h-12 rounded-xl bg-secondary-black border border-mint/10 flex items-center justify-center transition-all duration-500 hover:border-emerald group relative overflow-hidden">
                ...
                <svg className="w-5 h-5 text-muted-text group-hover:text-deep-black relative z-10 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  <path d={social.path} />
                </svg>
              </a>
            ))}
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20 pt-8 border-t border-mint/5 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-muted-text text-xs font-medium uppercase tracking-widest opacity-60 font-heading">
