    ...
    <section className="bg-primary py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16 md:mb-20">
          <h2 className="text-3xl md:text-5xl font-black text-text-primary mb-6 font-heading">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
           ...
           {features.map((feature, idx) => (
             <div key={idx} className="relative pt-8 group">
               {/* Dot on line */}
               <div className="hidden md:block absolute top-[43px] left-1/2 -translate-x-1/2 w-3 h-3 bg-primary border-2 border-emerald rounded-full z-10 group-hover:bg-emerald transition-colors duration-300 shadow-[0_0_10px_rgba(80,200,120,0.5)]"></div>
               
               <div className="text-center p-8 rounded-2xl bg-secondary/50 border border-transparent hover:border-mint/10 transition-all duration-300">
