...
const Testimonials = () => {
    ...
    return (
        <section className="bg-secondary py-20 md:py-40 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 md:mb-20 gap-8">
                    <div className="max-w-2xl">
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-7xl font-black text-text-primary tracking-tighter uppercase italic font-heading">
                            FOUNDER <span className="text-mint">STORIES.</span>
                        </h2>
                    </div>
                    <p className="text-text-secondary text-base md:text-lg max-w-xs border-l border-emerald/30 pl-6 font-body">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 relative z-20">
                    {stories.map((story, idx) => (
                        <div key={idx} className="group relative p-8 md:p-12 bg-primary rounded-[2.5rem] border border-mint/5 hover:border-emerald/30 transition-all duration-700">
                            ...
                            <div className="flex justify-between items-start mb-8 md:mb-10">
                                ...
                                <span className="text-[9px] md:text-[10px] font-mono text-text-secondary opacity-40">VERIFIED_LOG_0{idx + 1}</span>
                            </div>

                            <p className="text-xl md:text-2xl text-text-primary leading-relaxed font-medium mb-8 md:mb-10 relative font-body">
                            ...
                            <div className="flex items-center justify-between pt-8 border-t border-mint/5">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-secondary border border-mint/10 rounded-full flex items-center justify-center text-emerald font-black font-heading">
                                        {story.author.charAt(0)}
                                    </div>
                                    <div>
                                        <h4 className="font-black text-text-primary tracking-tight font-heading">{story.author}</h4>
